...
{
    //Essa classe cria uma DataAnnotation customizada para validações ServerSide
    //no caso, a DataAnnotation é Moeda e precisa seguir o padrão <Nome>Attribute
    ...
    //Para fazer com que a validação funcione ClientSide, no JS, é necessário criar um Adapter e também um Provider (classe seguinte) que irá fazer o Adapter funcionar
